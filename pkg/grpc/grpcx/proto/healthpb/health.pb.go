...
const (
	...
	HealthCheckResponse_TERMINATING HealthCheckResponse_ServingStatus = 3
)
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\x05proto\"\x14\n" +
	"\x12HealthCheckRequest\"\xa4\x01\n" +
	"\x13HealthCheckResponse\x12@\n" +
	"\x06status\x18\x01 \x01(\x0e2(.proto.HealthCheckResponse.ServingStatusR\x06status\"K\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x02\x12\x0f\n" +
	"\vTERMINATING\x10\x032\xd3\x01\n" +
	"\x06Health\x12A\n" +
	"\bLiveness\x12\x19.proto.HealthCheckRequest\x1a\x1a.proto.HealthCheckResponse\x12B\n" +
	"\tReadiness\x12\x19.proto.HealthCheckRequest\x1a\x1a.proto.HealthCheckResponse\x12B\n" +
	"\tTerminate\x12\x19.proto.HealthCheckRequest\x1a\x1a.proto.HealthCheckResponseB\x14Z\x12/healthpb;healthpbb\x06proto3"
...
var file_health_proto_depIdxs = []int32{
	...
	1, // 1: proto.Health.Liveness:input_type -> proto.HealthCheckRequest
	1, // 2: proto.Health.Readiness:input_type -> proto.HealthCheckRequest
	1, // 3: proto.Health.Terminate:input_type -> proto.HealthCheckRequest
	2, // 4: proto.Health.Liveness:output_type -> proto.HealthCheckResponse
	2, // 5: proto.Health.Readiness:output_type -> proto.HealthCheckResponse
	2, // 6: proto.Health.Terminate:output_type -> proto.HealthCheckResponse
